...
const systemIconSvg = (
	<svg width="800" height="800" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
		<path d="M26 32h-1.74a3.6 3.6 0 0 1-1.5-2.52v-1.35h-9.52v1.37a3.6 3.6 0 0 1-1.5 2.5h-1.8a1 1 0 1 0 0 2h16.12a.92.92 0 0 0 1-1A1 1 0 0 0 26 32" className="clr-i-solid clr-i-solid-path-1" />
		<path d="M32.5 3h-29A1.5 1.5 0 0 0 2 4.5v21A1.5 1.5 0 0 0 3.5 27h29a1.5 1.5 0 0 0 1.5-1.5v-21A1.5 1.5 0 0 0 32.5 3M31 21.83H5V7h26Z" className="clr-i-solid clr-i-solid-path-2" />
